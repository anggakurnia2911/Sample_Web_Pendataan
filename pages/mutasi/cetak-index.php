...
class PDF extends FPDF
{
    ...
    {
      // Logo
      $this->Image('../../assets/img/logo-kab.png',20,10);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,8,'PENGURUS RT. 07 RW 05',0,1,'C');
        $this->Cell(308,8,'PERUMAHAN JUNTI ASRI, KECAMATAN KATAPANG',0,1,'C');
    	$this->Cell(308,8,'KABUPATEN BANDUNG',0,1,'C');
    	// Line break
    	$this->Ln(5);
